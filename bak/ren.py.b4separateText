...
#convert -gravity center -geometry +0+500 img.gif text.png -compose Lighten -composite tmp.png; convert -gravity center -geometry +0-600 tmp.png logo.png -compose Lighten -composite test.png 
		...
		cmd = "convert " + textImg + " -fill '" + rgb_to_hex(clrText[0], clrText[1], clrText[2]) + "' -colorize 100% " + textImgClr + "; "
		cmd += "composite " + textImg + " -compose Multiply " + textImgClr + " " + textImgClr
		print "\nExecuting " + cmd + "..."
		os.system(cmd)
		print

		cmd = "convert -gravity center -geometry +0+" + textOfs + " " + tifRen + " " + textImgClr + " -compose Lighten -composite " + tempImg + ";"
