...
"""
		...
		cmd = "convert " + gifRen + " -resize 630x891 " + gifRen
		exeCmd(cmd)
		print
	...
	def renPostProcess(self):
		...
		cmd = "convert " + gifRenPost + " -resize 630x891 " + gifRenPost
		print "\nExecuting " + cmd + "..."
		os.system(cmd)
		print
	...
	def updateUi(self):
		...
		if self.parmDic["renPost"] == 1:
			self.photo.configure(file=gifRenPost);
		else:
