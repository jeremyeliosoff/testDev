...
gifRenRegRes = mncDir + "/imgRegRes.gif"
tifRenPost = mncDir + "/imgPost.tif"
gifRenPost = mncDir + "/imgPost.gif"
gifRenPostRegRes = mncDir + "/imgPostRegRes.gif"
...
"""
		...
		cmd = "convert " + gifRen + " -resize 630x891 " + gifRenRegRes
		exeCmd(cmd)
		print
	...
	def renPostProcess(self):
		...
		cmd = "convert " + gifRenPost + " -resize 630x891 " + gifRenPostRegRes
		print "\nExecuting " + cmd + "..."
		os.system(cmd)
		print
	...
	def updateUi(self):
		...
		if self.parmDic["renPost"] == 1:
			self.photo.configure(file=gifRenPostRegRes);
		else:
			self.photo.configure(file=gifRenRegRes);
