...
"""
		...
		if self.parmDic["compText"] == 1:
			...
			#print
				...
				cmd = "convert " + img + " -brightness-contrast -50x0 -resize " + scRel + "% -fill '" + rgb_to_hex(clrText[0], clrText[1], clrText[2]) + "' -colorize 100% " + textImgClr + "; "
				num =  str(float(k)*100 - 100)
				cmd += "\nconvert -brightness-contrast " + num + "x0 " + textImgClr + " " + textImgClr + "; "
				cmd += "\ncomposite " + img + " -resize " + scRel + "% -compose Multiply " + textImgClr + " " + tempImg
				exeCmd(cmd)
				print
